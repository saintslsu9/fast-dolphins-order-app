...
# Page styling (blue and white theme)
st.markdown(
    """
    <style>
    .main {background-color: #F0F8FF;}
    .title {color: #003366; font-size: 36px; font-weight: bold;}
    .subtitle {color: #003366; font-size: 24px; font-weight: bold;}
    </style>
    """, unsafe_allow_html=True
)

st.markdown("<div class='title'>FAST Dolphins Merchandise Orders</div>", unsafe_allow_html=True)
st.markdown("<div class='subtitle'>Simple View + Completed Orders</div>", unsafe_allow_html=True)

# Option to view completed orders
view_completed = st.checkbox("Show Completed Orders Only")
...
if view_completed:
    ...
    if completed_orders.empty:
        ...
        for i in completed_orders.index:
            ...
            st.write(f"🟦 {athlete_name} — {size} — Qty {qty}")
else:
